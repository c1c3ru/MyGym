...
/**
 * Tipos para o sistema de envio de emails de convite
 */
...
const EMAIL_TEMPLATES = {
  pt: {
    subject: (academiaName: string) => `Convite para ${academiaName}`,
    greeting: 'Olá!',
    inviteMessage: (inviterName: string, academiaName: string, userType: string) =>
      `<strong>${inviterName}</strong> convidou você para fazer parte da <strong>${academiaName}</strong> como <strong>${userType}</strong>.`,
  ...
  en: {
    subject: (academiaName: string) => `Invitation to ${academiaName}`,
    greeting: 'Hello!',
    inviteMessage: (inviterName: string, academiaName: string, userType: string) =>
      `<strong>${inviterName}</strong> invited you to join <strong>${academiaName}</strong> as <strong>${userType}</strong>.`,
  ...
  es: {
    subject: (academiaName: string) => `Invitación a ${academiaName}`,
    greeting: '¡Hola!',
    inviteMessage: (inviterName: string, academiaName: string, userType: string) =>
      `<strong>${inviterName}</strong> te invitó a formar parte de <strong>${academiaName}</strong> como <strong>${userType}</strong>.`,
...
export const sendInviteEmail = functions.https.onCall(
  async (data: SendInviteEmailRequest, context): Promise<SendInviteEmailResponse> => {
