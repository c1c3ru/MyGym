                ...
                <View style={styles.modernCardHeader}>
                  ...
                  <View>
                    <Text style={styles.modernCardTitle}>
                      {getString("todaySchedule")}
                    </Text>
                    <Text style={styles.modernCardSubtitle}>
                      {dashboardData.todayClasses.length}{" "}
                      {getString("classesScheduled")}
                    </Text>
                  </View>
                </View>
              ...
              <Card.Content>
                <View style={styles.modernCardHeader}>
                  ...
                  <View>
                    ...
                    <Text style={styles.modernCardSubtitle}>
                      {getString("directAccessFunctionalities")}
                    </Text>
                  </View>
                </View>
                ...
                <View style={styles.modernQuickActions}>
                  ...
                  <Animated.View
                    style={[
                      styles.actionCard,
                      { opacity: animations.fadeAnim, marginTop: 10 },
                    ]}
                  >
                    <View style={styles.actionGradient}>
                      <MaterialCommunityIcons
              ...
              <Card.Content>
                <View style={styles.modernCardHeader}>
                  ...
                  <View style={styles.headerTitleContainer}>
                    ...
                    <Text style={styles.modernCardSubtitle}>
                      {getString("importantCommunications")}
                    </Text>
                  </View>
                  <AnimatedButton
                    icon="refresh"
