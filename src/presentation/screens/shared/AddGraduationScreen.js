...
const AddGraduationScreen = ({ route, navigation }) => {
  ...
  const defaultGraduationLevels = [
    { id: COLORS.COLORS.white, name: 'Faixa Branca', color: COLORS.COLORS.white, order: 1 },
  ...
  const getGraduationColor = (levelName, index) => {
    ...
    const defaultColors = [COLORS.COLORS.white, COLORS.warning[400], COLORS.warning[500], COLORS.primary[500], COLORS.info[500], COLORS.secondary[500], COLORS.gray[700], COLORS.black];
