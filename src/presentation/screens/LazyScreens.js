...
export const LazyAdminDashboard = withLazyLoading(AdminDashboard, getString('loadingDashboard'));
...
export const LazyInstructorDashboard = withLazyLoading(InstructorDashboard, getString('loadingDashboard'));
export const LazyInstructorClasses = withLazyLoading(InstructorClasses, 'Carregando suas turmas...');
export const LazyStudentDashboard = withLazyLoading(StudentDashboard, getString('loadingDashboard'));
