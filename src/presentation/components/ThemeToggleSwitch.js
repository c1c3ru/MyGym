...
import { SPACING, FONT_SIZE, FONT_WEIGHT, BORDER_RADIUS } from '@presentation/theme/designTokens';
      ...
      <Card.Content>
        ...
        <View style={styles.switchRow}>
          <View style={styles.switchInfo}>
            <Text style={[styles.switchLabel, { color: currentTheme.text.primary }]}>
              {themeInfo.name}
            </Text>
            <Text style={[styles.switchDescription, { color: currentTheme.text.secondary }]}>
        ...
        <View style={styles.themeOptions}>
          <Text style={[styles.optionsTitle, { color: currentTheme.text.primary }]}>
            Temas Disponíveis
          </Text>
          ...
          >
            <View style={styles.themePreview}>
              ...
              <View style={styles.previewInfo}>
                <Text style={[styles.themeName, { color: currentTheme.text.primary }]}>
                  Dark Premium
                </Text>
                <Text style={[styles.themeDesc, { color: currentTheme.text.secondary }]}>
