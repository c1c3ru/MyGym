...
export const languages: Record<LanguageCode, any> = {
  pt: {
    ...
    strings: {
      ...
      beltsByModality: 'Faixas por Modalidade',
      ...
      viewingAllClasses: 'Visualizando todas as turmas da academia',
      classesCreatedByAdmin: 'As turmas criadas pelo administrador aparecerão aqui.',

      // ADMIN CLASSES FILTERS
      filterAllClasses: 'Todas as Turmas',
      filterActiveClasses: 'Turmas Ativas',
      filterInactiveClasses: 'Turmas Inativas',
      filterFullClasses: 'Turmas Cheias',
      filterEmptyClasses: 'Turmas Vazias',
      filterNoInstructor: 'Sem Instrutor',
      statsClassStats: 'Estatísticas das Turmas',
      statsActiveClasses: 'Turmas Ativas',
      ...
      theme: 'Tema',
      notificationsAndBackup: 'Notificações e Backup',
      ...
      manageYourStudents: 'Gerencie seus alunos',
      ...
      noRecentCheckIns: 'Nenhum check-in recente',
      ...
      confirmDeleteClassWithName: 'Tem certeza que deseja excluir a turma {className}?',
      ...
      // REPORTS & ANALYTICS
      reportsTotalClasses: 'Total Aulas',
      reportsFrequency: 'Frequência',
      reportsRevenue: 'Receita',
      reportsAvgStudentFrequency: 'Frequência Média de Alunos',
      reportsCapacityUsed: 'Capacidade Utilizada',
      reportsClassDetail: 'Detalhamento por Turma',
      reportsClassTableClass: 'TURMA',
      reportsClassTableEnrolled: 'MATRICULADOS',
      reportsClassTablePresence: 'PRESENÇA',
      reportsClassTableStatus: 'STATUS',
      reportsStable: 'Estável',
      reportsRecentHistory: 'Histórico Recente',
      reportsMonthTableMonth: 'MÊS',
      reportsMonthTableTotalStudents: 'ALUNOS TOTAIS',
      reportsMonthTableEstimatedRevenue: 'RECEITA ESTIMADA',
      reportsEnrolledLower: 'matriculados',
      reportsGeneratedBy: 'Documento gerado automaticamente pelo MyGym Software para Instrutores.',
      reportsAllRightsReserved: 'Todos os direitos reservados ©',
      reportsExportTitle: 'Relatório MyGym',
      reportsSheetGeneral: 'Relatório Geral',
      reportsCategory: 'Categoria',
      reportsPeriod: 'Período',
      reportsPrimaryMetric: 'Métrica Primária',
      reportsSecondaryMetric: 'Métrica Secundária',
      reportsDetails: 'Detalhes',
      reportsEvolutionMonthly: 'Evolução Mensal',
      reportsPopularClasses: 'Aulas Populares',
      reportsSummary: 'Resumo',
      reportsWeek: 'Semana',
      reportsMonth: 'Mês',
      reportsYear: 'Ano',
      reportsAnalyzesAndReports: 'Relatórios e Análises',
      reportsOverview: 'Visão Geral',
      reportsThisMonth: 'Este mês',
      reportsGrowth: 'crescimento',
      reportsMostPopularClasses: 'Aulas Mais Populares',
      reportsStudentsLower: 'alunos',
      reportsLastMonthsEvolution: 'Evolução dos Últimos Meses',
      reportsExportReports: 'Exportar Relatórios',
      reportsExportPDF: 'Exportar PDF',
      reportsExportExcel: 'Exportar Excel',
      reportsActivityReport: 'Relatório de Atividades',
      reportsGeneratedAt: 'Gerado em:',
  ...
  en: {
    ...
    strings: {
      ...
      beltsByModality: 'Belts by Modality',
  ...
  es: {
    ...
    strings: {
      ...
      modality: 'Modalidad',
      modalities: 'Modalidades',
      beltsByModality: 'Cinturones por Modalidad',
