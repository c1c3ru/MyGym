...
export const languages: Record<LanguageCode, any> = {
  pt: {
    ...
    strings: {
      ...
      // ACADEMY
      academy: getString('academy'),
      student: getString('student'),
      students: getString('students'),
      instructor: getString('instructor'),
      instructors: getString('instructors'),
      class: getString('class'),
      classes: getString('classes'),
      graduation: getString('graduation'),
      graduations: getString('graduations'),
      belt: 'Faixa',
      belts: 'Faixas',
      modality: getString('modality'),
      modalities: getString('modalities'),
      payment: getString('payment'),
      payments: getString('payments'),
      schedule: 'Horário',
      schedules: 'Horários',
      lesson: 'Aula',
      lessons: 'Aulas',
      ...
      saving: getString('saving'),
      processing: getString('processing'),
      ...
      errorLoadingData: getString('errorLoadingData'),
