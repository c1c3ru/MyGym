...
class NodeMailerService {
  ...
  async sendEmail(to, subject, html, text = null) {
    try {
      ...
      const mailOptions = {
        from: `"MyGym" <${EMAIL_CONFIG.auth.user}>`,
        to,
        subject,
        html,
  ...
  async sendPasswordRecoveryEmail(email, resetLink, userName = '') {
    const subject = 'Recuperação de Senha - MyGym';
    ...
    <body>
        <div class="container">
            ...
            <p>Recebemos uma solicitação para redefinir a senha da sua conta no MyGym.</p>
            ...
            <div class="footer">
                <p>MyGym - Sistema de Gestão de Academias</p>
